        ...
        success: function (responseData) {
            ...
            if (MyjsonObj != "") {
                ...
                for (var i = 0, l = MyjsonObj.length; i < l; i++) {
                    ...
                    AppendHtml += " <li><a href=\"" + MyjsonObj[i]["Product_Redirect"] + "\" target=\"_blank\"><img src=\"" + MyjsonObj[i]["product_IndexPic"] + "\" url=\"" + MyjsonObj[i]["Product_Redirect"] + "\" bigImg=\"" + MyjsonObj[i]["product_IndexPic"] + "\"></a></li>"
                }

                $('#produc_ul').html(AppendHtml);
            }
        },
    ...
    $.ajax({
        ...
        success: function (responseData) {
            ...
            if (MyjsonObj != "") {
                ...
                var imonth = GetMonth(imydate.toDateString().split(" ")[1]);
                var iday = imydate.toDateString().split(" ")[2];

                AppendHtml += "<span class=\"m2_yue\">" + imonth + "月</span>"
...
function GetMonth(idate) {
    var remonth;
    switch (idate) {
        case "Jan": remonth = "一"; break;
        case "Feb": remonth = "二"; break;
        case "Mar": remonth = "三"; break;
        case "Apr": remonth = "四"; break;
        case "May": remonth = "五"; break;
        case "Jun": remonth = "六"; break;
        case "Jul": remonth = "七"; break;
        case "Aug": remonth = "八"; break;
        case "Sep": remonth = "九"; break;
        case "Oct": remonth = "十"; break;
        case "Nov": remonth = "十一"; break;
        case "Dec": remonth = "十二"; break;
    }
    return remonth;
}
        ...
        success: function (responseData) {
            ...
            if (MyjsonObj != "") {
                ...
                if (MyjsonObj[0]["news_Redirect"] != null) {
                    ...
                    AppendHtml += "<a class=\"newslist_1_more\" href=\"" + MyjsonObj[0]["news_Redirect"] + "\">查看详情 >></a>";
                }
                else {
                    AppendHtml += "<a class=\"newslist_1_more\" href=\"newsdetail.shtml#" + MyjsonObj[0]["news_Id"] + "\">查看详情 >></a>";
                }
                AppendHtml += "</div>"
        ...
        success: function (responseData) {
            ...
            if (MyjsonObj != "") {
                ...
                for (var i = 0, l = MyjsonObj.length; i < l; i++) {
                    ...
                    var imgBgNews = MyjsonObj[i]["news_Pic"] ? MyjsonObj[i]["news_Pic"] : 'images/nophoto.jpg'
                    AppendHtml += "<div class=\"newslist_li_left\"><img src=\"" + imgBgNews + "\" /></div>";
                    AppendHtml += "<div class=\"newslist_li_right\">";
                    AppendHtml += "<h2>" + MyjsonObj[i]["news_Title"] + "</h2>";
                    AppendHtml += "<div class=\"i2_date\">";
                    AppendHtml += "<h3>" + imonth + "月</h3>" + iday;
                    AppendHtml += "</div>";
                    AppendHtml += "<div>";
    ...
    $.ajax({
        ...
        success: function (responseData) {
            ...
            if (MyjsonObj != "") {
                ...
                AppendHtml += "来源：" + MyjsonObj["news_From"];
                AppendHtml += "&nbsp;&nbsp;发布于：" + idate;
                AppendHtml += "</div>";
